...
})(exports.attachmentTypes || (exports.attachmentTypes = {}));
/**
...
})(exports.messageSources || (exports.messageSources = {}));
...
})(exports.authErrors || (exports.authErrors = {}));
...
})(exports.snippetsErrors || (exports.snippetsErrors = {}));
...
})(exports.sharedErrors || (exports.sharedErrors = {}));
/**
 * Updates sources
 */
var updatesSources;
...
const getPeerType = (id) => {
    if (CHAT_PEER < id) {
        return exports.messageSources.CHAT;
    }
    if (id < 0) {
        return exports.messageSources.GROUP;
    }
    return exports.messageSources.USER;
};
/**
...
const { CAPTCHA_REQUIRED, USER_VALIDATION_REQUIRED, CONFIRMATION_REQUIRED } = exports.apiErrors;
...
const fetchCookieDecorator = (jar = new toughCookie.CookieJar()) => {
    const setCookie = util.promisify(jar.setCookie).bind(jar);
    const getCookieString = util.promisify(jar.getCookieString).bind(jar);
...
const { INVALID_PHONE_NUMBER, AUTHORIZATION_FAILED, FAILED_PASSED_CAPTCHA, FAILED_PASSED_TWO_FACTOR } = exports.authErrors;
/**
...
class AccountVerification {
    ...
    async processCaptchaForm(response, $) {
        ...
        const { key, validate } = await this.vk.callbackService.processingCaptcha({
            type: exports.captchaTypes.ACCOUNT_VERIFICATION,
...
const { CAPTCHA_REQUIRED: CAPTCHA_REQUIRED$1, TOO_MANY_REQUESTS, USER_VALIDATION_REQUIRED: USER_VALIDATION_REQUIRED$1 } = exports.apiErrors;
...
const { INVALID_PHONE_NUMBER: INVALID_PHONE_NUMBER$1, AUTHORIZATION_FAILED: AUTHORIZATION_FAILED$1, FAILED_PASSED_CAPTCHA: FAILED_PASSED_CAPTCHA$1, FAILED_PASSED_TWO_FACTOR: FAILED_PASSED_TWO_FACTOR$1 } = exports.authErrors;
/**
 * Number of two-factorial attempts
 *
 * @type {number}
...
class DirectAuth {
    ...
    async processCaptcha({ captcha_sid: sid, captcha_img: src }) {
        ...
        const { key, validate } = await this.vk.callbackService.processingCaptcha({
            type: exports.captchaTypes.DIRECT_AUTH,
            sid,
            src
        });
        this.captchaValidate = validate;
...
const { PAGE_BLOCKED, INVALID_PHONE_NUMBER: INVALID_PHONE_NUMBER$2, AUTHORIZATION_FAILED: AUTHORIZATION_FAILED$2, FAILED_PASSED_CAPTCHA: FAILED_PASSED_CAPTCHA$2, FAILED_PASSED_TWO_FACTOR: FAILED_PASSED_TWO_FACTOR$2 } = exports.authErrors;
/**
 * Blocked action
 *
 * @type {string}
...
class ImplicitFlow {
    ...
    async processAuthForm(response, $) {
        ...
        if ('captcha_sid' in fields) {
            ...
            const { key, validate } = await this.vk.callbackService.processingCaptcha({
                type: exports.captchaTypes.IMPLICIT_FLOW_AUTH,
                sid: fields.captcha_sid,
                src
            });
            this.captchaValidate = validate;
...
const { AUTHORIZATION_FAILED: AUTHORIZATION_FAILED$3 } = exports.authErrors;
...
const { AUTHORIZATION_FAILED: AUTHORIZATION_FAILED$4 } = exports.authErrors;
...
const { POLL } = exports.attachmentTypes;
...
const { GIFT } = exports.attachmentTypes;
...
const attachmentsTypes = {
    [exports.attachmentTypes.POLL]: () => PollAttachment,
    [exports.attachmentTypes.GIFT]: () => GiftAttachment,
    [exports.attachmentTypes.WALL]: () => WallAttachment,
    [exports.attachmentTypes.LINK]: () => LinkAttachment,
    [exports.attachmentTypes.PHOTO]: () => PhotoAttachment,
    [exports.attachmentTypes.AUDIO]: () => AudioAttachment,
    [exports.attachmentTypes.VIDEO]: () => VideoAttachment,
    [exports.attachmentTypes.DOCUMENT]: () => DocumentAttachment,
    [exports.attachmentTypes.MARKET]: () => MarketAttachment,
    [exports.attachmentTypes.STICKER]: () => StickerAttachment,
    [exports.attachmentTypes.GRAFFITI]: () => GraffitiAttachment,
    [exports.attachmentTypes.WALL_REPLY]: () => WallReplyAttachment,
    [exports.attachmentTypes.MARKET_ALBUM]: () => MarketAlbumAttachment,
    [exports.attachmentTypes.AUDIO_MESSAGE]: () => AudioMessageAttachment
};
/**
...
const { WALL } = exports.attachmentTypes;
...
const { PHOTO } = exports.attachmentTypes;
...
const { LINK } = exports.attachmentTypes;
...
const { AUDIO } = exports.attachmentTypes;
...
const { VIDEO } = exports.attachmentTypes;
...
const { MARKET } = exports.attachmentTypes;
...
const { STICKER } = exports.attachmentTypes;
...
const { GRAFFITI } = exports.attachmentTypes;
...
const { DOCUMENT } = exports.attachmentTypes;
/**
 * Types of documents
 *
 * @type {Map}
...
const { WALL_REPLY } = exports.attachmentTypes;
...
const { MARKET_ALBUM } = exports.attachmentTypes;
...
const { AUDIO_MESSAGE } = exports.attachmentTypes;
...
const { MISSING_PARAMETERS, NO_FILES_TO_UPLOAD, EXCEEDED_MAX_FILES, UNSUPPORTED_SOURCE_TYPE } = exports.uploadErrors;
const isURL = /^https?:\/\//i;
class Upload {
    /**
     * Constructor
...
const { APP_TOKEN_NOT_VALID, RESPONSE_SIZE_TOO_BIG } = exports.apiErrors;
const { EXECUTE_ERROR } = exports.collectErrors;
...
class MessageContext extends Context {
     ...
     */
    get isChat() {
        return this.peerType === exports.messageSources.CHAT;
    }
    /**
     * Check is a user
     */
    get isUser() {
        return this.senderType === exports.messageSources.USER;
    }
    /**
     * Checks is a group
     */
    get isGroup() {
        return this.senderType === exports.messageSources.GROUP;
    }
    /**
     * Checks is from the user
     */
    get isFromUser() {
        return this.peerType === exports.messageSources.USER;
    }
    /**
     * Checks is from the group
     */
    get isFromGroup() {
        return this.peerType === exports.messageSources.GROUP;
    }
    /**
...
const { NEED_RESTART, POLLING_REQUEST_FAILED } = exports.updatesErrors;
...
class Updates {
    ...
    async start({ webhook } = {}) {
        ...
        if (!this.vk.options.pollingGroupId) {
            try {
                ...
                if (error.code !== exports.apiErrors.WRONG_PARAMETER) {
                    throw error;
                }
    ...
    reloadMiddleware() {
        ...
        if (this.hearStack.length !== 0) {
            stack.push(middlewareIo.getOptionalMiddleware((context) => context.type === 'message' && !context.isEvent, middlewareIo.compose([
                ...this.hearStack,
...
const { INVALID_URL, INVALID_RESOURCE, RESOURCE_NOT_FOUND } = exports.snippetsErrors;
const numberRe = /^-?\d+$/;
...
const enumResourceTypes = {
    id: exports.resourceTypes.USER,
    club: exports.resourceTypes.GROUP,
    public: exports.resourceTypes.GROUP,
    app: exports.resourceTypes.APPLICATION
};
/**
 * Remove search param
 *
...
class ResourceResolver {
    ...
    async resolveScreenName(resource) {
        ...
        if (type === 'page') {
            return {
                id,
                type: exports.resourceTypes.GROUP
            };
        }
        return { id, type };
    }
...
class StreamingAPI {
    ...
    async startWebSocket() {
        ...
        const { socket } = this;
        this.close = util.promisify(socket.close).bind(socket);
...
const { MISSING_CAPTCHA_HANDLER, MISSING_TWO_FACTOR_HANDLER } = exports.sharedErrors;
...
exports.UserOnlineContext = VoteContext$1;
exports.VK = VK;
